		...
		do
		{
			...
			switch(option1)
			{
				...
				case 2:
					...
					System.out.println("Select any Option\n");
					System.out.println("	1.Registration for parking");
					...
					switch(option5)
					{
						case 1:
							...
							System.out.println("You have selected Registration for Taking Vehicle. Please provide the following information");
